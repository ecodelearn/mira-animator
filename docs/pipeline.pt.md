...
| **mira-postit** | Cria um mural de post-its ao vivo em dois slides: pergunta com QR no primeiro e, no segundo, cada resposta em texto livre colando como um post-it na vaga dela, um a um, 15 por página, com a seta virando a página. |
