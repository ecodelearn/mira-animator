...
| **mira-postit** | Builds a live post-it wall across two slides: question plus QR on the first, and on the second every free-text answer sticks into its own slot, one at a time, 15 per page, with the arrow key turning the page. |
