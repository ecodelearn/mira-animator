...
| **mira-postit** | Crea un mural de post-its en vivo en dos slides: pregunta con QR en el primero y, en el segundo, cada respuesta de texto libre pegándose en su plaza, uno a uno, 15 por página, con la flecha pasando de página. |
